package com.se.searchservice.config;

import com.se.searchservice.service.UserInfoTokenServices;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public ResourceServerTokenServices tokenServices() {
        ...
        userInfoTokenServices.setClientId("search-service");
        userInfoTokenServices.setClientSecret("search-service");
